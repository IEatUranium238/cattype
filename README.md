...
Download cattype executable for your os from [releases](https://github.com/IEatUranium238/cattype/releases).
...
Download JRE (Java 25+) and .jar from [releases](https://github.com/IEatUranium238/cattype/releases).
